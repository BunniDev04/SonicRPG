...
Date:		dc.b '(R)MRTR 2021.OCT' ; Release date
Title_Local:	dc.b 'SONIC THE HEDGEHOG RPG                          ' ; Domestic name
Title_Int:	dc.b 'SONIC THE HEDGEHOG RPG                          ' ; International name
...
Sonic_Index:
		...
		dc.w	Sonic_Display-Sonic_Index
; ---------------------------------------------------------------------------
...
Sonic_Move:
	...
	@cont:
		btst	#3,d0	; Is player pressing right?
		beq.s	@MoveLeft	; If not, branch
		add.w	d1,8(a0)	; Move right
		move.b	#1,$1C(a0)
		move.b	#1,$29(a0)	; Set movement direction to right
		bclr	#0,$22(a0)	; Set the sprite to not flipped
		bclr	#0,1(a0)

	@MoveLeft:
		btst	#2,d0	; Is player pressing left?
		beq.s	@MoveUp	; If not, branch
		sub.w	d1,8(a0)	; Move left
		move.b	#1,$1C(a0)
		move.b	#1,$29(a0)
		bset	#0,$22(a0)	; Set the sprite to flipped
		bset	#0,1(a0)

	@MoveUp:
		btst	#0,d0	; Is player pressing up?
		beq.s	@MoveDown	; If not, branch
		sub.w	d1,$C(a0)	; Move up
		move.b	#1,$1C(a0)
		move.b	#2,$29(a0)
		bclr	#0,$22(a0)
		bclr	#0,1(a0)
	...
	@MoveDown:
		btst	#1,d0	; Is player pressing down?
		beq.s	loc_1127E	; If not, branch
		add.w	d1,$C(a0)	; Move down
		move.b	#1,$1C(a0)
		move.b	#0,$29(a0)
		bclr	#0,$22(a0)
		bclr	#0,1(a0)
...
SAnim_Do:
	...
	@notRunning:
		...
		move.b	$29(a0),d4
		move.b	d4,d3		; d3 = $29(a0)
		lsl.b	#3,d4		; d4 = $29(a0)*8
		add.b	d4,d3		; d3 = $29(a0)*8 + $29(a0) = $29(a0) * 9
